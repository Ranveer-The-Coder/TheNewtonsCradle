...
function setup() {
	...
	bobObject1 = new Bob1(440,497,35);
	bobObject2 = new ball(500,497,35);
	bobObject3 = new ball(560,497,35);
	bobObject4 = new ball(620,497,35)
	bobObject5 = new ball(680,497,35)

	hook1 = new Ground (452,200,20,20)
 	hook2 = new Ground (525,200,20,20)
	hook3 = new Ground (597,200,20,20)
	hook4 = new Ground (670,200,20,20)
	hook5 = new Ground (743,200,20,20)
